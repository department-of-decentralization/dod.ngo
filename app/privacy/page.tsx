...
export default function Privacy() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div>We may collect and process data that you provide to us for the purpose
      ...
      <div>We use the following third party applications:</div>
      <ul>
        <li>
      ...
      <h3>Our details</h3>
      <div>This website is owned and operated by Goerli Dezentral gGmbH.</div>
      <div>
      ...
      <div>
        ...
        contact us via: <a href="mailto:data@dod.ngo">data@dod.ngo</a>
      </div>
      <Foot></Foot>
    </main>
  );
