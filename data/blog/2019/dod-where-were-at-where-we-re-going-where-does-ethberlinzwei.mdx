...
This is pretty redundant by now, so due to the very large wall of text that we wrote, here’s [ETHBerlinZwei ](http://2019.ethberlin.org)in a nutshell — or better put, what it will be.
