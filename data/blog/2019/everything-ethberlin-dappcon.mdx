...
tags: ['ETHBerlin', 'ZWEI', 'Hackathon', 'Conference']
...
- If you want to experience all of ETHBerlin — [then apply to make yourself useful somehow](https://2019.ethberlin.org) (judging, mentoring, hacking, sponsoring, volunteering, speaking)
