...
For Diffusion, knowing that the approach would be agnostic we focused on several bounties we mentioned in our previous [post](https://medium.com/ethberlin/interhackerobility-dod-joins-forces-with-outlier-ventures-to-push-the-diffusion-2019-hackathon-5a9db36bb6a), and our members now shifted from hackathon organisers to judges. Here are our top picks, and the winners! — thing is that we had a lot of favourites, but only 4 prizes to give (Outlier Ventures can testify we were the judging table to take the longest on making a decision — it might or might not have gotten ugly, and some of us might or might not be on speaking terms still):
...
![](https://cdn-images-1.medium.com/max/800/1*yXuFTruNkg4MqFi2LT--2g.png)
...
**DoD PICK — TriggeredX:**
![](https://cdn-images-1.medium.com/max/800/1*pXFqgGa7rRhKvKDI6xr_iw.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/1*Y549oXNU0e0HHz0MCEOwUg.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/1*K9HKnP-H4Q3IYkYNHRq4Tg.png)Screenshot from the subgraph they set up for the project
