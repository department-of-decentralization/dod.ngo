...
OGs will notice that we are following a similar format to ETHBerlin³, with the addition of some new prizes (and a couple of twists). One main difference is that ETHBerlin04 is a [sponsorless event](__GHOST_URL__/announcing-our-ethberlin04-experiment/), therefore we will have no sponsor bounties. But there is still plenty for you to hack on to keep you busy throughout the weekend.
