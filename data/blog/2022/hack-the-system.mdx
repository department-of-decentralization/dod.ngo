...
authors: ['Helena']
summary: 'ETHBerlin³ is two weeks away and the system is not going to hack itself.'
---
...
![Coders and non-coders uniting at ETHBerlinZwei](/static/images/2022/hack-1.jpg)

<div className="text-center">*Coders and non-coders uniting at ETHBerlinZwei*</div>

A kind reminder that the theme for this year's event is to provide an opportunity for hackers to (re-)connect to the original cypherpunk vision and build on it. We are inviting you to bring crypto back to its roots and hack the system. We expect everyone hacking has read our [manifesto](https://2022.ethberlin.org/manifesto/) and aligns with our values, and wants to join our mission to bring decentralised technology back to where it should be.
