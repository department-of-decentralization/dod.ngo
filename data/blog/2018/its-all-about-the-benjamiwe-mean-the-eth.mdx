...
![](https://cdn-images-1.medium.com/max/800/1*3hVp9LNrcDpwRr9mTqnImQ.png)How our sponsorship deck looked like
...
In our last[ post](https://medium.com/ethberlin/unapologetic-9a7a8f1417d1) we were unapologetic about how we wanted to create an event that, “No amount of money can get you on that stage. This is an educational event, content-based, for hackers and there is no way to waiver this.”
...
![](https://cdn-images-1.medium.com/max/800/1*DwusSe_QT--qYvZTKUqRzA.jpeg)Drumroll please.. or whatever works — we like noise!
