...
images: ['/static/images/2018/banner-8.jpg']
layout: PostBanner
---

_Words by _[_Christopher Heymann — 1kx_](https://twitter.com/1kxnetwork)
...
- _WOW Factor_: What else is there about the submission? Has this project and/or team defied expectations, based on timing, efforts, etc?i?
...
_(When I write we, I mean specifically:_
[_Mareen Glaske from Gnosis_](https://twitter.com/MareenGlaeske)_, _[_Maria Paula from Golem_](http://twitter.com/MPtherealMVP)_, _[_Lasse Clausen from 1kx_](https://twitter.com/lalleclausen)_, _[_Benjamin Bollen from OST _](https://twitter.com/BenjaminBollen)_and _[_Christopher Heymann from 1kx_](https://twitter.com/1kxnetwork)_.)_
...
_Details for submissions and the basic submission requirements will be announced soon. You can submit for both open track and sponsored prizes — always._
